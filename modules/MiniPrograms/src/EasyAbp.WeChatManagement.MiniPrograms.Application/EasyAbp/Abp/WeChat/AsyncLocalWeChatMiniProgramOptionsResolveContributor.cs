...
{
    public class AsyncLocalWeChatMiniProgramOptionsResolveContributor : IWeChatMiniProgramOptionsResolveContributor
    {
        public const string ContributorName = "WeChatManagementAsyncLocal";
