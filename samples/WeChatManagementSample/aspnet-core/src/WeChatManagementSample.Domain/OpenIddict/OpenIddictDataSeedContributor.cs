...
namespace WeChatManagementSample.OpenIddict;
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["WeChatManagementSample_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        var consoleAndAngularClientId = configurationSection["WeChatManagementSample_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl =
                configurationSection["WeChatManagementSample_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
