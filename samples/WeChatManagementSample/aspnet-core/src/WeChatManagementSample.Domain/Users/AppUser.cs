...
namespace WeChatManagementSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update WeChatManagementSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update WeChatManagementSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
