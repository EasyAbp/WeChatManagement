...
namespace WeChatManagementSample
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            var webFolder = Path.Combine(directoryInfo.FullName, $"samples{Path.DirectorySeparatorChar}WeChatManagementSample{Path.DirectorySeparatorChar}aspnet-core{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}WeChatManagementSample.Web.Ids4");
